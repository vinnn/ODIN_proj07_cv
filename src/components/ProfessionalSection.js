    ...
    this.setState( {
      ...
      itemList: this.state.itemList.map( itemi => { return ({...itemi, editMode: false})  } )
        ...
        // adds an item block with empty fields (in edit mode):
          const emptyItem = {company: "", title: "", role: "", dateFrom: "", dateTo: "", editMode: false, uid: uniqid()};
          this.setState({
            item: emptyItem,
...
export class Item extends Component {
  ...
  render() {
    // destructure the state (cleaner):
    const { company, title, role, dateFrom, dateTo, editMode, uid } = this.props.data;
...
export class ItemDisplay extends Component {
  ...
  render() {
    ...
    const { company, title, role, dateFrom, dateTo, uid, onClickEdit, onClickDelete } = this.props;
...
export class ItemEdit extends Component {
    ...
    render() {
    // destructure the props (cleaner):
    const { company, title, role, dateFrom, dateTo, uid, onChangeEdit, onClickSubmit, onClickCancel } = this.props;
